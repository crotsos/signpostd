...
(* OASIS_START *)
(* DO NOT EDIT (digest: be0c19d0bcce2a7ef9fdec8f1a0f6050) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "conn_test.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\169\1338\235r\177}\bG\015\183'iM\018/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
